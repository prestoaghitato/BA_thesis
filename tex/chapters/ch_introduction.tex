...
Within linguistics, the existing applications of pattern mining could hardly be further away from the present application.
...
The authors explore the use of mining techniques for stylistic analysis of texts by applying such tools to three corpora of poetry, letters, and fiction respectively \citep[\pnum{170}]{quiniou_what_2012}.
