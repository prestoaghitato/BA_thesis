...
\begin{figure}
	...
	\label{fig:species}
	\caption[Species known to engage in vocal or gestural turn-taking.]{A selection of species known to engage in vocal or gestural turn-taking. Based on \citet[\pnum{11}]{levinson_turn-taking_2016}.}
\end{figure}
...
%%%%%%%%%%%%%%%%
``“Multimodal motherese” is likely a natural, adaptive behavior that has evolved to transmit conventional word–referent relations to infants.'' \citep[\pnum{891}]{gogate_study_2000}
...
But, interestingly, within 2--5\s\ after one party had exhibited a signal, likelihood of the other party's response ``increased considerably and significantly for virtually all signal-response pairs'' \citep[\pnum{687}]{vanegeren_mother-infant_2001}.
...
But this is still an open question \citep{source}.\showcomment{this paragraph should probs be somewhere else}
