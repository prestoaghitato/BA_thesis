...
11 kinds of event of different modalities were hand-coded for both mother and child using the \textsc{elan} software \cite{wittenburg06}. Categories were chosen HOW??  % ELABORATE here
...
Referring again to Figure \ref{fig:idealseq}, one can observe the rules \fpmrule{A}{A,B} (because the start time point of the antecedent \fpmset{A} lies before that of the succedent \fpmset{A,B}) but not 
