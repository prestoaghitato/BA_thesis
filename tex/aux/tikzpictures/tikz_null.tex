...
%	\node[rotate=-90, anchor=south] at (13,1.5) {\textsc{null}};
	...
	\foreach \i in {0.25, 4.25}{  % top and bottom
		\node[anchor=east] at (2.75,{\i+2.5}) {\mosp};
		\node[anchor=east] at (2.75,{\i+2}) {\mogain};
		\node[anchor=east] at (2.75,{\i+1.5}) {\mogaob};
		\node[anchor=east] at (2.75,{\i+1}) {\invo};
		\node[anchor=east] at (2.75,{\i+0.5}) {\ingamo};
		\node[anchor=east] at (2.75,\i) {\ingaob};
	}
