...
\newcommand{\apewidth}{2cm}

\begin{tikzpicture}[
	every node/.append style={inner sep=0cm,align=center,text width=\apewidth,font=\footnotesize},
...
%% bottom apes
\node[below=2cm of lepilemur]	(hylobates)		{\includegraphics[width=\apewidth]{../aux/img/species/hylobates.jpg}};
...
node[midway,yshift=0.4cm]{\normalsize{prosimians}};
